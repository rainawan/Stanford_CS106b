/*
 * Solve challenging problems using the priority
 * queue class implemeneted in PQArray.
 */
...
STUDENT_TEST("enqueue and dequeue of pqSort") {
//    int startSize = 5000;
...
STUDENT_TEST("time operation topK") {
